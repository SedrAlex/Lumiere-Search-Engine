...
"""
Simple evaluation runner for ANTIQUE hybrid search system.
Make sure the hybrid search service is running on localhost:8006 before running this script.
"""
...
def check_service_running(url="http://localhost:8006"):
...
def start_service():
    ...
    service_script = "hybrid_antique_query_processing.py"
...
def run_evaluation():
    ...
    try:
        ...
        from evaluation_metrics import AntiqueEvaluator
        ...
        if results:
            ...
            # Save results
            output_file = f"quick_antique_evaluation_results_{int(time.time())}.json"
...
def main():
    """Main function."""
    print("ANTIQUE Hybrid Search Evaluation Runner")
    print("="*50)
